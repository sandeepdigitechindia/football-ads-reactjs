  ...
  const adsData = [
    {
      ...
      description: 'Our club is looking for talented football players for the upcoming season. Apply today!',
      link: '/ads/1',
    },
    {
      photo: '/ads/ads2.jpg',
      title: 'Professional Coaches Available for Hire',
      description: 'Experienced football coaches ready to take your game to the next level. Book now!',
      link: '/ads/2',
    },
    {
      photo: '/ads/ads3.jpg',
      title: 'Join the Best Football Agency',
      description: 'Get represented by one of the top football agencies. Make your mark in the industry.',
      link: '/ads/3',
    },
    {
      photo: '/ads/ads1.jpg',
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {adsData.map((ad, index) => (
            <div key={index} className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-2xl font-semibold text-gray-800 mb-4">{ad.title}</h3>
              <p className="text-gray-600 mb-4">{ad.description}</p>
              <a href={ad.link} className="text-blue-600 hover:underline">See More</a>
            </div>
          ))}
        </div>
